const fs = require('fs')
fs.readFile('Node/index.html', 'utf-8', (err,contenido) => { // El fs.readfile nos permite ver el contenido de un archivo, en este caso, el contenido de un archivo html
    if(err){
...
fs.rename('Node/index.html', 'Main.html' , (err) =>{
    if(err){
        throw err
    }else{
